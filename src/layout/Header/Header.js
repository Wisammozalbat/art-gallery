...
const Header = () => {
  ...
  return (
    <div className="header">
      ...
      <div
        className={[4 === current ? "slide active" : "slide", direction].join(
          " "
        )}
      >
      ...
      <div
        className={[3 === current ? "slide active" : "slide", direction].join(
          " "
        )}
      >
        <div className="header-title montserrat">
          <h1>ONLINE 3D EXHIBITION TOUR</h1>
      ...
      <div
        className={[2 === current ? "slide active" : "slide", direction].join(
          " "
        )}
      >
        <div className="header-title">
      ...
      <div
        className={[1 === current ? "slide active" : "slide", direction].join(
          " "
        )}
      >
        <div className="header-title">
      ...
      <div
        className={[0 === current ? "slide active" : "slide", direction].join(
          " "
        )}
      >
        <div className="header-title">
          <h1 className="main-slide__title">TrendArt</h1>
          <h3 className="subtitle main-slide__subtitle">
            We bring contemporary art closer to you
          </h3>
        </div>
